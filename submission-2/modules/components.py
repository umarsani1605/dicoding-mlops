...
def init_components(
    ...
    Args:
        ...
        transform_module (str): Path ke modul transformasi.
        training_module (str): Path ke modul pelatihan.
        serving_model_dir (str): Path ke direktori model.
 
    Returns:
        List: Daftar komponen TFX.
    """
